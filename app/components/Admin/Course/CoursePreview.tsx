...
const CoursePreview:FC<Props> = ({active, setActive, courseData, handleCourseCreate, isEdit}) => {
  ...
  return (
    <div className='w-[90%] m-auto py-5 pb-20'>
        ...
        <div className='w-full flex items-center justify-between'>
            ...
            <button className='w-full 800px:w-[180px] h-[40px] bg-[#37a39a] text-center text-white rounded mt-8 cursor-pointer' onClick={() => createCourse()}>
